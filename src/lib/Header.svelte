<script lang="ts">
	import { getModalStore, LightSwitch, popup } from '@skeletonlabs/skeleton';
	import CommandBar from '$lib/CommandBar.svelte';
	import { showModalComponent } from '$misc/shared';
	import { account, autoLogin, isPro } from '$misc/stores';
...
<div class="flex justify-between">
	...
	<div class="gap-8 flex items-center">
		<div class="hidden md:flex items-center gap-4">
			...
			<!-- Discord -->
			<a target="_blank" rel="noreferrer" href="https://shipbit.de/discord" class="w-5 h-5">
