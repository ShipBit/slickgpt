<div class="max-w-4xl mx-auto px-4 sm:px-6 mb-16 flex flex-col gap-12" lang="de">
	...
	<div class="flex flex-col gap-2">
		...
		<p>
			Telefon: <a class="anchor" href="tel:+4915111784387">+49 (0)151 11784387</a>
			<br /> E-Mail:
			<a class="anchor" href="mailto:info@shipbit.de">info@shipbit.de</a>
		</p>
	</div>

	<div class="flex flex-col gap-2">
		<h2 class="h2">Umsatzsteuer-ID</h2>
		<p>
	...
	<div class="flex flex-col gap-2">
		<h2 class="h2">Verbraucherstreitbeilegung / Universalschlichtungsstelle</h2>
		<p>
